                ...
                <div class="nav-menus-wrapper" style="transition-property: none;">
                    ...
                    @if (is_plugin_active('real-estate') && RealEstateHelper::isRegisterEnabled())
                        <ul class="nav-menu nav-menu-social align-to-right">
                            <li>
                                <a href="{{ route('public.account.properties.create') }}" class="text-primary"><img src="{{ Theme::asset()->url('') }}/img/submit.svg" width="20" alt="" class="mr-2" /> {{ __('Add Property') }}</a>
                            </li>
                            ...
                            @else
                                <li class="add-listing">
                                    <a href="{{ route('public.account.login') }}"><img src="{{ Theme::asset()->url('') }}" width="12" alt="" class="mr-2" />{{ __('Sign In') }}</a>
                                </li>
                            @endif
                        </ul>
